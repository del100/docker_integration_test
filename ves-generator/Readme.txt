...
docker run -v $(pwd)/db:/docker-entrypoint-initdb.d -e MONGO_INITDB_ROOT_USERNAME=root -e MONGO_INITDB_ROOT_PASSWORD=zXcVbN123! -e MONGO_INITDB_DATABASE=pnf_simulator --name mongo mongo
